...
This skill provides three concrete strategies for navigating around obstacles by reframing problems.
When stuck, instead of pushing harder on the current approach, try inverting the problem.
...
**Approach:** You got an answer, but not to your original question. What question DOES your data
answer?
...
**Strategy 1 (Unfix Parameters):** | Fixed Parameter | If This Floated | Alternative Approaches |
Assessment | |----------------|-----------------|----------------------|------------| | [Param 1] |
[Consequences] | [Options] | [Value] |

**Strategy 2 (Comparable Goals):** | Original Goal | Why It Failed | Comparable Goal | Value
Assessment | |--------------|---------------|----------------|------------------| | [Goal A] |
[Reason] | [Goal B] | [Compare impact] |
