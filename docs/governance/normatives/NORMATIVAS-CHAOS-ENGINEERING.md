...
Version: 1.0.0 Framework: Principles of Chaos Engineering (principlesofchaos.org) + LitmusChaos +
Chaos Mesh Last updated: 2026-05-11

---

## 1. PROPOSITO

Define los estandares de Chaos Engineering para el stack Gentle-Vanguard. Establece la madurez de
resiliencia, experimentos controlados de caos, y verificacion de que los sistemas soportan fallos
inesperados sin degradacion catastrófica.
...
function Invoke-ChaosExperiment { param( [string], [string], [hashtable], [scriptblock] )
