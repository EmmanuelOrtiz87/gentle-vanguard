...
- Default: `npm run watchtower:health` (154 checks, 29 components incl. `apps-registry` que
  vigila las 9 apps vía Command Center; expect full PASS — WARN/FAIL solo si hay basura real).
