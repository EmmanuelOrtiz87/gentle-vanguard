...
No toda referencia a `.ps1` es una dependencia funcional: puede ser histórica, documental o parte
de un cambio local pendiente. Antes de eliminar o restaurar una ruta se revisan callers,
