...
Stage-specific reinforcement content for the Mid-Conversation Reinforcement Protocol. At every stage
transition, the orchestrator injects the relevant row from this table into the reinforcement
template.
