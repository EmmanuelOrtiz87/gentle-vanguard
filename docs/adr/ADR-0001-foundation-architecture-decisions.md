...
Engram provides persistent cross-session memory with hot/warm/cold tiering. All architectural
decisions are stored in Engram for future reference.
...
14 workflows covering validation, quality, security, testing, and releases. All workflows use
minimum `contents: read` permissions, concurrency groups, and timeout limits.
