...
Sometimes the most valuable ADR is about a decision you *didn't* take:
...
- We'll revisit when: a) Team grows to 15+ b) Deployment takes >30m c) Features need different scaling
```
