...
This document outlines the normative guidelines and safety guards for Bedrock-compatible providers
within the Gentle Vanguard stack.
...
- **Unsupported Parameters**: `reasoning_effort` and similar provider-specific attributes that are
...
Any request to Bedrock-compatible providers must include configuration that drops unsupported
parameters:
