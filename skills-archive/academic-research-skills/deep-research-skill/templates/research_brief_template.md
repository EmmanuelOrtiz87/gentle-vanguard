...
**Title**: [Descriptive title in sentence case] **Date**: [YYYY-MM-DD] **Mode**: Quick Research
Brief **AI Disclosure**: This brief was produced with AI-assisted research tools. All findings are
...
**Evidence strength**: [Strong / Moderate / Emerging] **Source(s)**: [Brief citation]
