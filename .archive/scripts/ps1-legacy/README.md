...
These PowerShell scripts were migrated to TypeScript as part of the PS1→TS migration. They are
archived here for reference only. **Do not use or reference them.**
