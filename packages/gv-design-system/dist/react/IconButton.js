...
export const IconButton = forwardRef(function IconButton(
  { variant = 'default', size = 'md', icon, disabled, className = '', ...rest },
  ref,
) {
  const classes = ['gv-icon-btn', `gv-icon-btn--${variant}`, `gv-icon-btn--${size}`, className]
    .filter(Boolean)
    .join(' ');
  return _jsx('button', {
    ref: ref,
