...
- MUST execute C:/Workspace_local/gentle-vanguard/src/tools/pre-process-input.ts BEFORE every user response
...
1. Pre-process user input via C:/Workspace_local/gentle-vanguard/src/tools/pre-process-input.ts
