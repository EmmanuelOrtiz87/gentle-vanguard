---
name: scvi-tools-skill
description: >
  Knowledge work plugin from bio-research department.
metadata:
  source: knowledge-work-plugins
  original-name: scvi-tools
  department: bio-research
---

# scvi-tools Deep Learning Skill

This skill provides guidance for deep learning-based single-cell analysis using scvi-tools, the
leading framework for probabilistic models in single-cell genomics.
