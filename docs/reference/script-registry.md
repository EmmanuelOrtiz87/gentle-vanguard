...
| src/review/validate-gitflow.ts
<!-- REF-OBSOLETA: eliminado; migrado a src/review/validate-gitflow.ts --> | GitFlow Policy | B |

manual | platform | Enforces branch naming, protected branch push policy, and expected PR base |
