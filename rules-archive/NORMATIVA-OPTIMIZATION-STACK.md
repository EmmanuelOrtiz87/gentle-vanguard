...
Garantizar que todas las optimizaciones de tokens y costos de API se mantengan activas, verificables
y nunca se degraden por cambios no controlados.
...
Ejecutar `scripts/validation/verify-optimization-stack.ps1` para validar las 8 reglas. Este script
forma parte del health-check general y del CI pipeline.
