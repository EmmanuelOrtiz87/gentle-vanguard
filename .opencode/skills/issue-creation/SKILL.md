...
- Report a bug in the Gentle-Vanguard stack
- Request a new feature or enhancement
- Open any GitHub issue on the repository (`EmmanuelOrtiz87/gentle-vanguard`)
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/EmmanuelOrtiz87/gentle-vanguard/issues
...
gh issue create \
  ...
  --title "fix(agent): model delegation not detected on Windows"
```
