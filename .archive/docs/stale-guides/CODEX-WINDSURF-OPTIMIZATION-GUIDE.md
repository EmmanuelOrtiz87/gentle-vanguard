...
Estandarizar y potenciar el uso de Codex y Windsurf con configuraciones prácticas, seguras y
eficientes para trabajo diario en este repositorio.
...
- Rutas y guía corregidas: [docs/agents/CODEX.md](../agents/CODEX.md)
