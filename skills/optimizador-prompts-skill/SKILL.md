...
description: >
  ...
  clear, structured prompts ready for AI tools. Trigger: "mejora este prompt", "conviértelo en
  un prompt", "ordena esta idea", "hazme un prompt para", "optimiza esto para", "te voy a dictar
  una idea desordenada", "improve this prompt", "optimize prompt", "structure this idea",
  "create a prompt for", "make a prompt for", "turn this into a prompt"
license: Apache-2.0
metadata:
...
[Lista breve de 3 a 5 mejoras aplicadas]

**Dudas opcionales:** *(solo si hay información que mejoraría el resultado)*
