...
Code is communication. Every name, structure, and abstraction should reveal intent. If you need a comment to explain _what_ the code does, the code is failing at communication.
