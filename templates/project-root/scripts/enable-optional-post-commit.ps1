...
if ($Disable) {
    ...
    Write-Host "To re-enable, run: .\scripts\enable-optional-post-commit.ps1" -ForegroundColor Cyan
    exit 0
}
...
Write-Host "Disable anytime with: .\scripts\enable-optional-post-commit.ps1 -Disable" -ForegroundColor Cyan
