...
.DESCRIPTION
    Checks that all scripts have proper documentation, READMEs exist,
    and documentation follows standards

.PARAMETER Path
    Root path to validate (default: current directory)
...
.EXAMPLE
    .\validate-documentation.ps1 -Path "scripts\utilities" -Verbose
        ...
        return $false, "
{
  ...
  "currency": "USD",
  "latency": 52.204,
  "time_to_first_token": 3.746,
  "time_to_generate": 48.458
}