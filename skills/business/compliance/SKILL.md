...
description: >
  Legal and regulatory compliance — GDPR, HIPAA, SOX, ISO, AML, KYC, data protection.
  Trigger: "compliance", "regulatory", "gdpr", "hipaa", "sox", "iso", "aml", "kyc",
...
- **ISO 27701**: Privacy information management — PIMS, PII controls
- **AML/KYC**: Anti-money laundering — customer due diligence, suspicious activity reports
