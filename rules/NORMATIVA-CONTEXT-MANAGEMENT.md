...
> **Status**: Active (aprobada tras investigación 2026-08-13)
> **Scope**: Todas las sesiones con consumo de tokens >10K promedio
> **Referencia**: docs/reference/OPENCODE-CONTEXT-CONFIG.md
...
❌ **NO** ignorar la compaction nativa y crear solución custom
❌ **NO** fork de herramienta sin agotar native config first
❌ **NO** dejar sesiones sin context management documentado
❌ **NO** usar defaults sin verificar impacto en sesiones largas
...
**Aprobada por**: Investigación sistema 2026-08-13
**Revisión**: Review engram memo #2798
