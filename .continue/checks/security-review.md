...
- SQL queries built with string concatenation or template literals -- convert to parameterized
  queries
- Sensitive data (passwords, tokens, PII) written to logs or stdout -- remove or redact
- New crypto code using weak algorithms (MD5, SHA1 for security, ECB mode) -- replace with stronger
  alternatives
