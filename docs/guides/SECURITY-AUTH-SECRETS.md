...
- For web APIs or services, implement authentication middleware (e.g., JWT, OAuth2, or API key
  header).
...
- Store secrets in `.env.local` (gitignored) or a secure vault (e.g., Azure Key Vault, AWS Secrets
  Manager).
