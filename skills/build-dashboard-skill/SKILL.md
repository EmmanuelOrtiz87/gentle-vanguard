...
Chart.js patterns: line, bar, doughnut, stacked bar, mixed — see
[chart patterns](references/CHART_PATTERNS.md).

### 6. Add Interactivity

Dropdown filters, date range, sortable tables, combined filter logic — see
