...
## Overview
This document establishes the governance framework for model usage within the Gentle Vanguard stack, ensuring accountability, proper authorization, and clear normative guidelines.
