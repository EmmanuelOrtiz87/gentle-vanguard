...
Incorporar ~20 skills metodológicas de mercury-agent-skills al stack GV y establecer un pipeline de
seguridad con skillspector para vetar skills externas.
...
4. Copiar a `skills/<category>/` con naming GV (`prompt-engineering-skill/`, `clean-code-skill/`,
   etc.)
