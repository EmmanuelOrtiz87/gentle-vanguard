...
Al actualizar engram mientras un cliente MCP (OpenCode) esta corriendo, el binario en disco se actualiza pero el subproceso MCP en memoria sigue siendo el viejo. Esto causa:
