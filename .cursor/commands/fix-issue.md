...
5. Run tests to verify: `pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/validation/run-tests.ps1`
6. Run agent-verify: `pwsh -NoProfile -ExecutionPolicy Bypass -File scripts/utilities/agent-verify.ps1`
