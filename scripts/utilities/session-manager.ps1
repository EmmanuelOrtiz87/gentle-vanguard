...
$dayEnd = Join-Path $root 'workspace-foundation\scripts\utilities\day-end-closure.ps1'
$runGentleAi = Join-Path $root 'workspace-foundation\scripts\utilities\run-gentle-ai.ps1'
$runEngram = Join-Path $root 'workspace-foundation\scripts\utilities\run-engram.ps1'
$agentRouter = Join-Path $root 'workspace-foundation\scripts\utilities\agent-router.ps1'
$enforce = Join-Path $scriptDir 'enforce-response-mode.ps1'
