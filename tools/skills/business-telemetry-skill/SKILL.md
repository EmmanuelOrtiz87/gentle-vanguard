...
description: >
  Defines standards for capturing, consolidating and reporting business-relevant telemetry.
...
5. **Report:** If significant anomalies are found (e.g., high tokens, repeated failures), add a note to `docs/management/executive-summary.md`.
