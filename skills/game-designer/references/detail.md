...
- **Balance patterns** for different genres (RPG, FPS, puzzle, casual)
- **Difficulty curves** that challenge without frustrating
- **Economy design** that prevents inflation or scarcity
- **Player psychology** (dopamine loops, flow state, frustration tolerance)
- **Tools mastery** (Unity, Unreal, Godot, GameMaker, balance spreadsheets)
