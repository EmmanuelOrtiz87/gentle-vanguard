...
Auto-maintenance: prune checkpoints, compact event store, clean graphify snapshots, optimize session state.

## Trigger
"mantenimiento", "limpiar", "prune", "optimizar", "compactar", "maintenance", "cleanup", "optimize", "compact"
