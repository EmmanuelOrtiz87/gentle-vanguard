...
Source x Theme cross-tabulation for systematic evidence mapping. Used by the synthesis_agent to
organize evidence before writing the synthesis narrative.
...
**Date compiled**: [YYYY-MM-DD] **Total sources**: [N] **Themes identified**: [N]
