...
const r1 = benchmark(
  'dashboard-start.ts (original)',
  'npx',
  ['tsx', 'src/dashboard-start.ts', '--no-browser']
);
...
const r3 = benchmark(
  'start-optimized.bat (modo rápido)',
  'cmd',
  ['/c', 'start-optimized.bat']
);
...
const r4 = benchmark(
  'start-optimized.bat (modo completo)',
  'cmd',
  ['/c', 'start-optimized.bat', '--complete']
);
