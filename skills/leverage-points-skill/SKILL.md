...
description: >
  Donella Meadows' leverage points hierarchy for identifying high-impact intervention points.
metadata:
...
1. **Map** current interventions to the hierarchy
2. **Look higher** — ask "what's the higher-leverage version?"
3. **Assess feasibility** — higher leverage = more resistance
4. **Choose** the highest leverage you can actually execute
