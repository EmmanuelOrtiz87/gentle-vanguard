...
Per-source quality assessment card. Used by the source_verification_agent to systematically evaluate
each source entering the research pipeline.
...
**Level**: [I / II / III / IV / V / VI / VII] **Justification**: [why this level]
...
**Date**: [YYYY-MM-DD] **Sources assessed**: [N] **Assessor**: source_verification_agent
...
**Assessment**: [Strong / Adequate / Mixed / Weak] **Recommendation**: [Proceed / Supplement / Major
revision of source base needed]
```
