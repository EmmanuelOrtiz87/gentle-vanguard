...
description: >
  Imported from mercury-agent-skills. Use when working with "clean code", "code quality", "refactoring", "readability", "maintainability". Triggers: "clean code", "code quality", "refactoring", "readability", "maintainability".
metadata:
