...
**IMPORTANT**: Start every session with "Iniciar sesion" to ensure proper workflow.

See [SESSION-GUIDE.md](SESSION-GUIDE.md) for complete session instructions.
...
```powershell
.\scripts\project\setup-project.ps1 -ProjectPath "C:\existing-project"
```

### Configure AI

See [AI-CONFIGURATION.md](AI-CONFIGURATION.md) for AI provider setup.
