# Gentle-Vanguard social launch kit
...
Replace the neutral CTA “LINK EN BIO” only after the public handles and registration link exist. The
SVG sources are the editable masters; PNG and MP4 files are exports.
