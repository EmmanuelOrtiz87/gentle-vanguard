...
Version: 1.0.0 Framework: RESTful API Maturity Model (Richardson) + GraphQL best practices + OpenAPI
3.1 Last updated: 2026-05-11

---

## 1. PROPOSITO

Define los estandares de diseno de API para el stack Gentle-Vanguard. Aplica a todas las APIs REST,
GraphQL, y WebSocket desarrolladas o consumidas por el framework.
