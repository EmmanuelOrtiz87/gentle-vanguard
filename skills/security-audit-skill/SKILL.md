...
description: >
  Imported from mercury-agent-skills. Use when working with "security audit", "vulnerability assessment", "OWASP", "security review". Triggers: "security audit", "vulnerability assessment", "OWASP", "security review".
metadata:
