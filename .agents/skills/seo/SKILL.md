...
name: seo
description:
  Optimize for search engine visibility and ranking. Use when asked to "improve SEO", "optimize for
  search", "fix meta tags", "add structured data", "sitemap optimization", or "search engine
  optimization".
license: MIT
metadata:
...
| Technical SEO                     | ~15%      | ✓                                                  |
| Page experience (Core Web Vitals) | ~10%      | See [web.dev/vitals](https://web.dev/vitals/) |
| On-page SEO                       | ~10%      | ✓                                                  |
