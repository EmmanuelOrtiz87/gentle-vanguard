  ...
  return _jsxs('div', {
    ...
    children: [
      ...
      _jsxs('div', {
        ...
        children: [
          iconLeft &&
            _jsx('span', { className: 'gv-input__icon gv-input__icon--left', children: iconLeft }),
          _jsx('input', {
            ref: ref,
            id: id,
          ...
          iconRight &&
            _jsx('span', {
              className: 'gv-input__icon gv-input__icon--right',
              children: iconRight,
            }),
        ],
      }),
      hint &&
        !error &&
        !success &&
        _jsx('span', { id: hintId, className: 'gv-input__hint', children: hint }),
      error &&
        _jsx('span', {
          id: messageId,
          className: 'gv-input__error',
          role: 'alert',
          children: error,
        }),
      success &&
        !error &&
        _jsx('span', { id: messageId, className: 'gv-input__success', children: success }),
    ],
  });
});
