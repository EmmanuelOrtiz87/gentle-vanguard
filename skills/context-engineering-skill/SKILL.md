...
1. **Session Start (resuming work)**: `wf compact-start -Objective "..."` (or
...
2. **Mid-Session Context Pack**: `wf context-pack -Objective "..."` (or
...
4. **Session Handoff**: Run `wf end-session` → `context-pack` → save objective + next steps → new
