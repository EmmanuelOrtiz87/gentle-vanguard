...
description: >
  Imported from mercury-agent-skills. Use when working with "audit logging", "compliance", "observability", "agent tracing". Triggers: "audit logging", "compliance", "observability", "agent tracing".
metadata:
