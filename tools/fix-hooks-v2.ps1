...
if ($content) {
    $content = $content -replace 'GENTLEMAN_ROOT', 'FOUNDATION_ROOT'
    ...
    $content = $content -replace 'Ejecutando chequeos automaticos de las 7 dimensiones...', 'Running automated checks for 7 dimensions...'
    ...
    $content = $content -replace 'Chequeos de las 7 dimensiones completados.', '7 dimension checks completed.'
    $content = $content -replace 'No hay cambios en configuraciones', 'No configuration changes'
