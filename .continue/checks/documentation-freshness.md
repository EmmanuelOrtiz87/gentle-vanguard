...
- A public function, class, or type signature was added or changed -- update README, inline docs, or
  JSDoc
- Configuration options were added or renamed (config files, env vars, CLI flags) -- update relevant
  docs
...
No changes needed if the PR does not touch public APIs or configuration, or if docs were already
updated.
