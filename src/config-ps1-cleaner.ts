...
const PS1_TO_TS: Record<string, string | null> = {
  ...
  'scripts/utilities/ops/STATE-PERSISTENCE/rollback-orchestrator.ps1': 'src/rollback-orchestrator.ts',
  ...
  'scripts/utilities/profile/PROFILE-ADAPTIVE/adaptive-opencode-profile.ps1': 'src/adaptive-opencode-profile.ts',
  'scripts/utilities/profile/PROFILE-ADAPTIVE/adaptive-codex-windsurf-profile.ps1': 'src/adaptive-codex-windsurf-profile.ts',
  ...
  'scripts/utilities/WORKFLOW-ORCHESTRATION/validate-system-health.ps1': 'src/validate-system-health.ts',
  'scripts/utilities/WORKFLOW-ORCHESTRATION/orchestrator-next-steps.ps1': 'src/orchestrator-next-steps.ts',
  'scripts/utilities/WORKFLOW-ORCHESTRATION/intelligent-validator.ps1': 'src/intelligent-validator.ts',
  ...
  'scripts/utilities/git/GIT-VERSION-CONTROL/pre-commit-validation.ps1': 'src/pre-commit-validation.ts',
  ...
  // Audit
  'scripts/utilities/AUDIT-REPORTING/generate-session-artifacts.ps1': 'src/generate-session-artifacts.ts',
  ...
  'scripts/utilities/AI-AGENT-MANAGEMENT/sync-agent-instructions.ps1': 'src/sync-agent-instructions.ts',
  'scripts/utilities/AI-AGENT-MANAGEMENT/collect-provider-telemetry.ps1': 'src/collect-provider-telemetry.ts',
  
  // Deployment
  'scripts/utilities/DEPLOYMENT/install-github-runner.ps1': 'src/install-github-runner.ts',
  'scripts/utilities/DEPLOYMENT/migrate-gentle-vanguard-remotes.ps1': 'src/migrate-gentle-vanguard-remotes.ts',
  ...
  'scripts/utilities/TELEMETRY-METRICS/validate-report-simple.ps1': 'src/dashboard/validate-report-simple.ts',
  'scripts/utilities/TELEMETRY-METRICS/extract-engram-json.ps1': 'src/extract-engram-json.ts',
  
  // Performance
  'scripts/utilities/PERFORMANCE-OPTIMIZATION/optimize-performance-root.ps1': 'src/optimize-performance-root.ts',
  ...
  'scripts/utilities/workflow/WORKFLOW-ORCHESTRATION/homologate-local.ps1': 'src/homologate-local.ts',
  'scripts/utilities/workflow/WORKFLOW-ORCHESTRATION/orchestrator-governance-integration.ps1': 'src/orchestrator-governance-integration.ts',
  'scripts/utilities/workflow/WORKFLOW-ORCHESTRATION/event-governance-layer.ps1': 'src/event-governance-layer.ts',
  'scripts/utilities/workflow/WORKFLOW-ORCHESTRATION/validate-system-health.ps1': 'src/validate-system-health.ts',
  
  // Resilience
  'scripts/utilities/resilience-handler.ps1': 'src/resilience-handler.ts',
  
  // Agent router
  'scripts/utilities/agents/AI-AGENT-MANAGEMENT/collect-provider-telemetry.ps1': 'src/collect-provider-telemetry.ts',
  ...
  // Installer
  'scripts/utilities/INSTALLER/gentle-vanguard-installer-tui.ps1': 'src/installer/gentle-vanguard-installer-tui.ts',
  ...
  'scripts/utilities/orchestrate-auto-fix/auto-fix-delegate.ps1': 'src/orchestrate-auto-fix/auto-fix-delegate.ts',
  'scripts/utilities/orchestrate-auto-fix/pre-push-script-validator.ps1': 'src/pre-push-script-validator.ts',
  'scripts/utilities/orchestrate-auto-fix/cross-workspace-validator.ps1': 'src/cross-workspace-validator.ts',
  
  // Codegraph
  'scripts/utilities/codegraph/codegraph-post-modification-sync.ps1': 'src/codegraph-post-modification-sync.ts',
...
function cleanJsonFile(filePath: string, apply: boolean): ChangeLog {
  ...
  const pwshCommands = [
    { pattern: /pwsh\s+-NoProfile\s+-Command\s+"&\s+'([^']+\.ps1)'[^"]*"/g, replacement: 'npx tsx $1' },
