...
This document outlines the protocol for maintaining correct, functional, integrated, autonomous, documented, learned, updated, and normalized opencode configurations within the Gentle Vanguard stack.
...
This protocol ensures that opencode configurations remain correct, functional, integrated, autonomous, documented, learned, updated, and normalized at all times.