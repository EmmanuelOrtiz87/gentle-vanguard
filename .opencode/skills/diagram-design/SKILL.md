---
name: diagram-design
description: Create branded editorial diagrams (architecture, flowchart, sequence, state machine, ER, timeline, swimlane, quadrant, radar, loop, tree, org chart, Venn, pyramid, bar, line, Gantt, scatter, process, medallion, data flow, DP integration, DP security matrix) as standalone HTML/SVG/PNG. Redraw drawio/Mermaid sources.
triggers:
  - diagram
