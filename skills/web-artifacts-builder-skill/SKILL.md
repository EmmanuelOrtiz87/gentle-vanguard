...
description: >
  ...
  Trigger: "web artifact", "html component", "interactive demo", "prototype",
...
Build interactive web artifacts that render directly in browser as single-page applications or components.
...
.result{font-size:3rem;font-weight:bold}
</style>
</head>
<body>
