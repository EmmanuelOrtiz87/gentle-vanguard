...
This template provides the skeleton for an in-depth case study paper analyzing specific
institutions, programs, events, or phenomena.
...
[Background and case significance: 1-2 sentences.] [Purpose: 1 sentence.] [Method and data sources:
1-2 sentences.] [Key findings from the case: 2-3 sentences.] [Lessons and transferability: 1
sentence.]
...
[To what extent can lessons from this case apply elsewhere? (Note: case studies aim for
