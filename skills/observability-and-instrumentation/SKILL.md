...
aliases: ["observability-and-instrumentation"]
description: >
...
metadata:
  ...
  migrated: true
  migratedAt: "2026-08-09T21:55:57.071Z"
  originalPath: C:\Workspace_local\gentle-vanguard\.opencode\skills\observability-and-instrumentation\SKILL.md
  version: "1.0.0"
---
...
Log events as JSON with stable names, correlation IDs, and structured fields. Never log secrets. See
`references/process-guide.md`.

### 4. Metrics

RED for endpoints (Rate, Errors, Duration). USE for resources. Cardinality is the failure mode. See
`references/process-guide.md`.

### 5. Distributed tracing

OpenTelemetry auto-instrumentation. Propagate context across async boundaries. See
`references/process-guide.md`.
