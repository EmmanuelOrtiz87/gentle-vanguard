...
If a choice affects more than one future project, it belongs in the workspace foundation.
If a choice affects only one repository, it belongs in that project's `docs/project-context.md`.
