...
> **Bindings not shown here:** This README covers the most common managed-agents flows for
> TypeScript. If you need a class, method, namespace, field, or behavior that isn't shown, WebFetch
> the TypeScript SDK repo **or the relevant docs page** from `shared/live-sources.md` rather than
> guess. Do not extrapolate from cURL shapes or another language's SDK.
