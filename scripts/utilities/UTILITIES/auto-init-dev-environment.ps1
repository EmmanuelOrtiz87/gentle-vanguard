...
if (-not $Quiet) {
    Write-Host "Gentle-Vanguard - Development Stack - Auto Environment Init" -ForegroundColor Magenta
    Write-Host "Ensuring development environment is ready..." -ForegroundColor White
    Write-Host ""
}

if ($projectRoot) {
    Write-Info "Detected Gentle-Vanguard - Development Stack project at: $projectRoot"
    ...
    Write-Info "No Gentle-Vanguard - Development Stack project detected in current directory tree"
...
if (-not $Quiet) {
    ...
    Write-Host ""
    Write-Host "The Gentle-Vanguard - Development Stack development environment is now active." -ForegroundColor White
    Write-Host "Use '.\scripts\utilities\gv.ps1 status' to check project status" -ForegroundColor Cyan
    Write-Host "Use '.\scripts\utilities\gv.ps1 health' to re-run tool activation" -ForegroundColor Cyan
    Write-Host ""
}
