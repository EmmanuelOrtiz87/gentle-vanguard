---
title: Gentle-Vanguard Consulting Services Agreement
...
## GENTLE-VANGUARD STACK CONSULTING

---

**CONTRATO N.º**: GV-CONSULTING-[CLIENTE]-[FECHA]
...
- [ ] 1 sesión de handover (2h)

**Duración estimada**: 2-5 días hábiles
...
- [ ] Soporte de 30 días post-migración

**Duración estimada**: 1-7 días por proyecto
...
- [ ] 30 días de soporte post-training

**Duración**: 1-3 días (según nivel del equipo)
...
- [ ] 1 consulta presencial o virtual mensual (2h)
...
- Mercado Pago
- PayPal
- Cryptomonedas (BTC, ETH, SOL)

---

## 5. OBLIGACIONES DEL CONSULTOR

5.1 Prestar los servicios con la diligencia y profesionalismo propios del sector.

5.2 Cumplir con los plazos acordados, salvo circunstancias de fuerza mayor.

5.3 Mantener confidencialidad sobre información del Cliente.

5.4 Entregar documentación completa de los servicios realizados.
...
6.1 Proporcionar acceso a sistemas y ambientes necesarios.

6.2 Asignar un punto de contacto técnico.

6.3 Facilitar información y recursos requeridos.

6.4 Realizar pagos puntualmente según lo acordado.

6.5 Asistir a las capacitaciones programadas.

6.6 **Garantizar licencias de software** requeridas por el stack.
...
8.1 Ambas partes se comprometen a mantener estricta confidencialidad sobre información sensible.

8.2 Esta obligación perdura por 2 años post-terminación del contrato.

8.3 No aplica a información de dominio público o desarrollada independientemente.
...
10.1 Los servicios incluyen garantía de **30 días** sobre defectos de implementación.

10.2 No cubre: mal uso, modificaciones no autorizadas, problemas de terceros.

10.3 Exclusión de garantías implícitas salvo lo expresamente establecido.
...
12.1 El presente contrato se regirá por las leyes de **Argentina**.

12.2 Para todo litigio, las partes se someten a los tribunales de la **Ciudad de Buenos Aires**.

12.3 Ambas partes acuerdan intentar resolución amistosa antes de acciones judiciales.
...
14.1 El presente contrato constituye el acuerdo completo entre las partes.

14.2 Modificaciones sólo válidas por escrito firmadas por ambas partes.

14.3 La nulidad de cláusula no afecta el resto del contrato.

14.4 Cada parte conserva copia firmada de este documento.
