...
metadata:
  ...
  original-name: competitive-intelligence
  department: sales
---

# Competitive Intelligence

Research your competitors extensively and generate an **interactive HTML battlecard** you can use in
deals. The output is a self-contained artifact with clickable competitor tabs and an overall
comparison matrix.
...
> **No connectors?** Web research works great. I'll pull everything from public sources — product
> pages, pricing, blogs, release notes, reviews, job postings.
...
**Keep it Fresh** Run this skill again to refresh with latest intel. Recommended: monthly or before
major deals.
```
...
1. **Be honest about weaknesses** — Credibility comes from acknowledging where competitors are
   strong
2. **Focus on outcomes, not features** — "They have X feature" matters less than "customers achieve
   Y result"
3. **Update from the field** — Best intel comes from actual customer conversations, not just
   websites
