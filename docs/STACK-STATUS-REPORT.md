...
**Versión actual**: v2.28.0 (CHANGELOG: v2.28.0, README badges muestran v2.29.0-alpha)
**Fecha**: 2026-06-02/03
**Stack**: AI orchestration layer multi-herramienta | ~300+ scripts | ~386 skills | 27 CI/CD workflows
...
**Principio**: 100% agnóstico — funciona con OpenCode, Claude Code, Cline, Cursor, Windsurf, Codex, VS Code, Copilot, Antigravity.
...
| Auto-norm enforcer | `scripts/adaptive/auto-norm-enforcer.ps1` | ⚠️ Activo | Manual |
| Failure learning | `scripts/adaptive/failure-learning-system.ps1` | ⚠️ Activo | Manual |
| Cache manager | `scripts/adaptive/cache-manager.ps1` | ⚠️ Activo | Automático (sesión) |
...
| Karpathy enforcer | `scripts/adaptive/karpathy-enforcer.ps1` | ⚠️ Activo | Manual |
...
| Issue | Detalle |
|---|---|
| ⚠️ **v2.29.0-alpha inconsistencia** | README badges muestran v2.29.0-alpha, VERSION dice v2.28.0 |
| ⚠️ **FT Python stub** | `train_lora.py` es stub, no implementado |
| ⚠️ **Adaptive scripts mayormente manuales** | auto-norm-learner, failure-learning, etc. no están en pipeline automático |
