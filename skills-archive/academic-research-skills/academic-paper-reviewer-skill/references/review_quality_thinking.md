...
A cognitive framework for producing high-quality reviews. Teaches **how to think** about paper
quality, not just what to score.
...
**If #5 is yes**: The argument depends on a single linchpin. Flag it — the paper's contribution is
only as strong as that one piece of evidence.
...
**Judgment heuristic**: Most authors overstate generalizability. If the sample is from one
university in one country, findings cannot claim to apply "generally" without qualification.
...
**Judgment heuristic**: If you can't articulate the delta in one sentence, either the contribution
is weak or the paper hasn't communicated it clearly. Both are review-worthy observations.
