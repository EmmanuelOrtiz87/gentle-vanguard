...
Converting hierarchical ASM JSON to flat 2D tables for LIMS import, spreadsheet analysis, or data
...
This keeps the output focused on experimental data. If you need schema version tracking for
compliance or audit purposes, consider storing the original ASM JSON alongside the flattened CSV, or
modify the flattening script to include these fields.
