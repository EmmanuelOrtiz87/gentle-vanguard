...
- [ADR Template & Lifecycle](references/adr-template.md) — Template, status lifecycle, and guidelines
...
- [README & Changelog](references/readme-changelog.md) — README structure, changelog format, and agent docs
