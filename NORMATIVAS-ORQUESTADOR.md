...
Este documento define las normativas, reglas y restricciones que **TODO** agente y subagente debe respetar en el workspace `workspace-foundation`.
...
5. **MUST NOT** ejecutar `git push`, `git commit`, o cualquier acción que modifique código después de fixes hasta que re-judgment complete.

6. **MUST NOT** guardar session summary o decir "done" hasta que cada JD (Judgment Day) alcance estado terminal (APPROVED o ESCALATED).
