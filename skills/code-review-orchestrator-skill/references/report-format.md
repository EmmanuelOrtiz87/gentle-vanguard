...
**Date:** 2026-04-08 14:30 **Scope:** all **Total Issues:** 24 (2 critical, 5 high, 10 medium, 7
low)
...
**File:** src/config/api.ts:15 **Category:** Security **Issue:** Hardcoded API key detected.
