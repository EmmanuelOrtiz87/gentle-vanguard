...
The more you share about past conversations, pain points, and stakeholder concerns, the more
tailored the asset will be.

### Upload Transcripts

If you have call recordings, meeting notes, or email threads, upload them. The skill will extract
key quotes and priorities.
...
First draft not quite right? Just say what to change. Colors, sections, messaging, flow — all
adjustable.
...
**Q: Does it work for any product/company?** A: Yes. The skill detects what you're selling from your
email domain and researches accordingly.

**Q: How does it know my prospect's brand colors?** A: It extracts them from the prospect's website
or brand guidelines. You can adjust after.

**Q: Can I use my company's branding instead?** A: Yes — after the first build, just ask to switch
to your brand colors.

**Q: What if the research is wrong?** A: Flag it and provide corrections. The skill will regenerate
with accurate info.

**Q: Can I export as PDF?** A: Yes — ask for a print-optimized version and use your browser's
print-to-PDF.
