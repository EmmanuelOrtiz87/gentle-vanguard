...
| [PROMPT-PLAYBOOK.md](supplementary/templates/PROMPT-PLAYBOOK.md) | Prompt templates for daily work |
| [CLOSEOUT-REPORT-TEMPLATE.md](supplementary/templates/CLOSEOUT-REPORT-TEMPLATE.md) | Standard closeout report template |
