...
Version: 1.0.0 Last updated: 2026-05-10 Framework: Centralized Error Handling Pattern + OWASP LLM06
(Excessive Agency)
...
Define el manejo de errores centralizado para todo el stack Gentle-Vanguard. Aplica a scripts
PowerShell, Python, Bash, workflows CI/CD, y agentes AI. Garantiza que los errores se capturen,
clasifiquen, registren y escalen de manera consistente.
...
```json
{
  ...
  "context": { "path": "config/missing.json", "expected": true },
  "source": "validate-configs.ps1"
}
```
