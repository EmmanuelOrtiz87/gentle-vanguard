...
2. **Purpose Limitation**: Process data only for declared purposes. NO secondary use without
   consent.
...
- Basis categories: Consent, Contract, Legal Obligation, Vital Interest, Public Task, Legitimate
  Interest
...
3. **Risk Assessment**: What could go wrong? (unauthorized access, data loss, profiling,
   discrimination)
