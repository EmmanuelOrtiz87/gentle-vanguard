...
**Applies to:** All AI agent invocations across all supported tools

---

## 1. Principle

Different tasks require different model capabilities. Using a large expensive model for a simple validation is wasteful. Using a small weak model for complex architecture is risky. This policy defines which model to use for which task, based on capability requirements and cost optimization.
