...
Activar el módulo `trust-layer-stage8` (src/review/review-lenses.ts) bajo el workflow de activación
de módulos experimentales (Fase 1 de madurez). Capa de confianza stage #8: lentes de revisión de
