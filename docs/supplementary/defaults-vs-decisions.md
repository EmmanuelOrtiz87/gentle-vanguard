...
This document explains what the workspace foundation owns and what each project must decide for
itself.
...
If a choice affects more than one future project, it belongs in the workspace foundation. If a
