...
**Product type:** Educación, servicios profesionales y software open source/local-first.
...
- Ordenar el trabajo con asistentes de IA, agentes, memoria, verificación y automatizaciones.
**Use cases:**
...
- Consultoría puramente técnica puede ignorar la adopción humana y el aprendizaje.
**What it costs them:** Tiempo perdido, compras de herramientas sin criterio, dependencia de procesos frágiles, retrabajo y oportunidades de negocio o aprendizaje que se escapan.
...
- Usa material propio del stack Gentle-Vanguard y ejemplos de trabajo real.
**How we do it differently:** Primero aclaramos el objetivo y el nivel; después elegimos herramientas, diseñamos el flujo y comprobamos el resultado.
**Why that's better:** Reduce la confusión y evita vender la IA como magia: la persona aprende una capacidad que puede volver a aplicar.
...
- “Quiero aprender sin que me vendan humo.”
**How they describe us:**
- “Una forma más ordenada de trabajar con asistentes de IA.”
- “Ingeniería de software para la ingeniería de IA.”
**Words to use:** claro, práctico, ruta, criterio, contexto, verificar, arquitectura, acompañamiento, local-first, casos reales.
**Words to avoid:** magia, garantizado, secreto, reemplaza a todos, ingresos asegurados, viral garantizado, el mejor del mundo.
**Glossary:**
| Term | Meaning |
|------|---------|
| Gentle-Vanguard | Marca que reúne Academy, stack y servicios. |
| Academy | Superficie de aprendizaje y cursos de IA y software. |
| Stack | Herramientas y procesos para trabajar con asistentes de IA. |
| Local-first | Datos y operación priorizados en el equipo local, con servidor opcional. |
