...
Common exit codes indicating resource issues (per
[nf-core docs](https://nf-co.re/docs/usage/troubleshooting/crash_halfway)):
...
> **Note**: For basic environment setup (Docker, Nextflow, Java installation), see the inline
> instructions in Step 1 of SKILL.md.
