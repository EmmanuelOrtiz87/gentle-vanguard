...
2. Watchtower health: `node --import tsx src/maintenance-watchtower.ts --action health --quiet`
...
8. Active checkpoints: `node --import tsx src/ops/checkpoint-manager.ts list`
