...
### Activation Triggers
- User mentions "parallel execution", "ejecución paralela", or "execution limits"
...
### Use Cases
1. **Multi-Agent Orchestration**: "Ejecutar 5 agentes en paralelo con límites de recursos"
2. **Token Budget Protection**: "Proteger presupuesto de tokens con circuit breaker"
3. **Resource-Aware Scheduling**: "Asignar tareas según disponibilidad de GPU/CPU"
4. **Dependency Optimization**: "Optimizar ejecución paralela respetando dependencias"
