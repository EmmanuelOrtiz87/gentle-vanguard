...
description: >
  Imported from mercury-agent-skills. Use when working with "accessibility", "WCAG", "inclusive design", "ARIA", "a11y". Triggers: "accessibility", "WCAG", "inclusive design", "ARIA", "a11y".
metadata:
