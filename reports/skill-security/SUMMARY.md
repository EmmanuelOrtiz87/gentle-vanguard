...
- **Prompt Injection**: 10 occurrences
- **Privilege Escalation**: 6 occurrences
- **Data Exfiltration**: 4 occurrences
- **Memory Poisoning**: 4 occurrences
...
- **project-orchestrator-skill**: Score 70 — HIGH — DO_NOT_INSTALL
