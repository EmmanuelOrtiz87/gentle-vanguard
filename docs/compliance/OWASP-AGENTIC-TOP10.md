...
This document maps Gentle-Vanguard's security controls to the OWASP Agentic AI Top 10 risks. Each
...
**Risk**: Attacker manipulates LLM via crafted input **Level**: Critical
...
**Risk**: Unvalidated LLM output causes harm **Level**: High
...
**Risk**: Malicious data in training set **Level**: Medium
...
**Risk**: Resource exhaustion attacks **Level**: Medium
...
**Risk**: Compromised dependencies **Level**: High
...
**Risk**: Leakage of confidential data **Level**: Critical
...
**Risk**: Vulnerable tool/plugins **Level**: High
...
**Risk**: LLM performs unauthorized actions **Level**: Critical
...
**Risk**: Excessive trust in LLM outputs **Level**: Medium
...
**Risk**: Unauthorized model extraction **Level**: Low
