...
| FF-004 | 2026-04-13 | Sync Drift Prevention | Add periodic drift report for Foundation vs consumers manifests/skills. | medium | done | orchestrator | Resuelto: `scripts/utilities/sync-drift-report.ps1` + `wf sync-drift` |
...
| FF-006 | 2026-04-13 | Local Workflow Performance | Profile and optimize `wf health/verify` runtime for faster local loops. | medium | done | orchestrator | Resuelto: `scripts/utilities/wf-benchmark.ps1` — PASS en SLOs (status 1.8s, health 2.1s) |
...
| FF-015 | 2026-04-19 | Git Hooks Robustness | Automatizar la verificación e instalación de hooks en setup/bootstrap de Foundation. | high | done | orchestrator | Resuelto: `scripts/utilities/install-hooks.ps1` — auto-instala todos los hooks con logging |
