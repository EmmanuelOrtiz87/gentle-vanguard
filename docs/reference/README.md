...
```
docs/reference/
├── 📖 README.md                    # This file - reference hub
├── 🏗️ ARCHITECTURE.md              # System architecture
├── 🤖 SUBAGENT-ARCHITECTURE.md    # Multi-agent topology
├── 📋 project-types.md             # Project templates
├── 🔧 tools.md                    # External tools
├── 📂 structure.md                # Directory layout
├── 📜 script-registry.md          # Script governance
├── 🎯 SKILL-ORGANIZATION.md      # Skill catalog
