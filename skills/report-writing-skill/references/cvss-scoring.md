...
Key fields: VC/VI/VA = Vulnerable System; SC/SI/SA = Subsequent System (downstream impact)
...
**Practical rule**: If program uses CVSS 4.0, include the full string starting with `CVSS:4.0/AV:...`. Programs cannot dispute a valid vector string.
