...
**Applies to:** All AI agent interactions, CLAUDE.md, AGENTS.md, skill definitions

---

## 1. Purpose

Context Engineering is the discipline of structuring, maintaining, and governing the information that shapes how AI coding agents behave. This document defines standards to ensure consistent, high-quality agent output across sessions and contributors.

Based on industry research (2026): teams practicing context engineering see 2-3x sustained ROI from AI coding tools vs. teams that only use raw prompting.
