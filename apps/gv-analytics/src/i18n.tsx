...
const STRINGS: Record<Locale, Record<string, string>> = {
  en: {
    ...
    'history.subtitleCount': '{shown} of {total} reports persisted in Nexus.',
    ...
    'history.from': 'From',
    'history.to': 'To',
    'history.sortToggle': 'Toggle date order',
    'history.newestFirst': 'Newest first',
    'history.oldestFirst': 'Oldest first',
    'history.resetFilters': 'Reset filters',
    'history.selectHint': 'Select rows with the checkbox to delete them in bulk.',
    'history.selectedN': '{n} selected',
    'history.deleteSelected': 'Delete selected ({n})',
    'history.deleteAll': 'Delete all',
    'history.delete': 'Delete report',
    'history.confirmSelected': 'Delete {n} report(s)? This cannot be undone.',
    'history.confirmAll': 'Delete ALL reports? This cannot be undone.',
    'history.confirmYes': 'Yes, delete',
    'history.confirmNo': 'Cancel',
    'history.deletedN': '{n} report(s) deleted.',
    'history.deletedAll': 'All reports deleted.',
    'history.selectAllPage': 'Select all rows on this page',
    'history.selectRow': 'Select row',
    'history.prevPage': 'Previous',
    'history.nextPage': 'Next',
    'history.pageOf': 'Page {page} of {total}',
    'conn.cancel': 'Cancel',
    'conn.cancelEdit': 'Discard changes and back to summary',
  ...
  es: {
    ...
    'history.subtitleCount': '{shown} de {total} reportes persistidos en Nexus.',
    ...
    'history.from': 'Desde',
    'history.to': 'Hasta',
    'history.sortToggle': 'Invertir orden por fecha',
    'history.newestFirst': 'Más recientes primero',
    'history.oldestFirst': 'Más antiguos primero',
    'history.resetFilters': 'Limpiar filtros',
    'history.selectHint': 'Marcá filas con el checkbox para eliminarlas en lote.',
    'history.selectedN': '{n} seleccionados',
    'history.deleteSelected': 'Eliminar seleccionados ({n})',
    'history.deleteAll': 'Eliminar todo',
    'history.delete': 'Eliminar reporte',
    'history.confirmSelected': '¿Eliminar {n} reporte(s)? No se puede deshacer.',
    'history.confirmAll': '¿Eliminar TODOS los reportes? No se puede deshacer.',
    'history.confirmYes': 'Sí, eliminar',
    'history.confirmNo': 'Cancelar',
    'history.deletedN': '{n} reporte(s) eliminados.',
    'history.deletedAll': 'Todos los reportes fueron eliminados.',
    'history.selectAllPage': 'Seleccionar todas las filas de esta página',
    'history.selectRow': 'Seleccionar fila',
    'history.prevPage': 'Anterior',
    'history.nextPage': 'Siguiente',
    'history.pageOf': 'Página {page} de {total}',
    'conn.cancel': 'Cancelar',
    'conn.cancelEdit': 'Descartar cambios y volver al resumen',
  ...
  'pt-BR': {
    ...
    'history.subtitleCount': '{shown} de {total} relatórios persistidos no Nexus.',
    ...
    'history.from': 'De',
    'history.to': 'Até',
    'history.sortToggle': 'Inverter ordem por data',
    'history.newestFirst': 'Mais recentes primeiro',
    'history.oldestFirst': 'Mais antigos primeiro',
    'history.resetFilters': 'Limpar filtros',
    'history.selectHint': 'Marque linhas com o checkbox para excluí-las em lote.',
    'history.selectedN': '{n} selecionados',
    'history.deleteSelected': 'Excluir selecionados ({n})',
    'history.deleteAll': 'Excluir tudo',
    'history.delete': 'Excluir relatório',
    'history.confirmSelected': 'Excluir {n} relatório(s)? Não pode ser desfeito.',
    'history.confirmAll': 'Excluir TODOS os relatórios? Não pode ser desfeito.',
    'history.confirmYes': 'Sim, excluir',
    'history.confirmNo': 'Cancelar',
    'history.deletedN': '{n} relatório(s) excluídos.',
    'history.deletedAll': 'Todos os relatórios foram excluídos.',
    'history.selectAllPage': 'Selecionar todas as linhas desta página',
    'history.selectRow': 'Selecionar linha',
    'history.prevPage': 'Anterior',
    'history.nextPage': 'Próxima',
    'history.pageOf': 'Página {page} de {total}',
    'conn.cancel': 'Cancelar',
    'conn.cancelEdit': 'Descartar alterações e voltar ao resumo',
