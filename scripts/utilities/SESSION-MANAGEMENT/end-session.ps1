...
- This artifact was generated by `gv.ps1 end-session`.
...
if ($hasPublicationRisk -and -not $AllowUnpublishedClose -and -not $Force) {
    ...
    Write-Warn 'Use gv.ps1 publish (recommended), or re-run end-session with -AllowUnpublishedClose to accept the risk.'
    exit 2
}
