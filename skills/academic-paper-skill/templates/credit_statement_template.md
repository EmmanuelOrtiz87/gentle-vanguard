...
Use this template to record author contributions using the CRediT (Contributor Roles Taxonomy)
framework. Fill in the contribution matrix, then use the output format to generate the CRediT
statement for your manuscript.
...
- The contribution matrix serves as an internal record; the text statement is what appears in the
  manuscript
- Some journals use their own submission system to collect CRediT data — in that case, use this
  template for preparation and enter the data into the journal's system during submission
- For single-author papers, a CRediT statement is typically not required, but the sole author is
  understood to have performed all roles
