...
> ⚠️ **NOTA IMPORTANTE**: Los datos de tokens, costos y contexto aún **NO están siendo capturados
> automáticamente**. Ver `reports/MEJORAS-REPORTING-TELEMETRY.md` para el plan de mejoras.
...
> **Leyenda**: NC = No Capturado | ✅ OK = Operativo | 🔴 ALTA = Prioridad alta | 🟡 MEDIA =
> Prioridad media
