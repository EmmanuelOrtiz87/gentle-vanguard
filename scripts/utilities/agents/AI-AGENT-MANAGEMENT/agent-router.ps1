...
$userSkillsPath = if ($env:CLAUDE_SKILLS_DIR) { $env:CLAUDE_SKILLS_DIR } elseif ($env:USERPROFILE) { Join-Path $env:USERPROFILE '.claude\skills' } else { Join-Path $repoRoot 'skills' }
...
$AGENT_SKILLS = @{
    ...
    'QA'  = @('testing-skill', 'playwright-skill', 'pytest-skill')
