...
|----|------|------------|--------|------|
| CORR-001 | ]`** in public-facing scripts. - **No `$args`** — always use named params. - Mandatory params use `[Parameter(Mandato... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| CORR-001 | eration failed: $_"     exit 1 } ```  Rules:  - **Never use `$ErrorActionPreference = 'SilentlyContinue'`** at script... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| CORR-001 | . 3. **Comment-Based Help**: All public functions must have `.SYNOPSIS`, `.DESCRIPTION`, `.EXAMPLE` 4. **Output Type*... | medium | DEVELOPMENT-STANDARDS.md | 2026-06-16 |
...
| CORR-001 | 1. Overview  All `.ps1` files in this repository MUST pass PSScriptAnalyzer with **zero errors**.   Warnings are anno... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| CORR-005 | ]`** in public-facing scripts. - **No `$args`** — always use named params. - Mandatory params use `[Parameter(Mandato... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| DOC-001 | may be optional by design   /  Any new exclusion must be added to **both** the CI workflow and this document with jus... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| DOC-001 | ---  ## 2. File Header Convention  Every script MUST begin with a documentation block:  ```powershell # script-name.p... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| DOC-001 | ceeding these are **advisory** (not blocking) but must be addressed in the same sprint.  ---  ## 11. PSScriptAnalyzer... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | val.ps1`. 4. `scripts/utilities/agent-verify.ps1` must fail if multilingual routing matrix has mismatches. 5. No conf... | medium | AI-NORMATIVES.md | 2026-06-16 |
| LEARN-001 | ence = 'SilentlyContinue'`** at script scope. - **Always check `$LASTEXITCODE`** after calling external executables. ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-001 | t-Content`              / Path traversal      / / Never expand environment variables from external config without san... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-001 | Windows 10+/Ubuntu 22.04+/macOS 13+ — all scripts must run on all platforms - PowerShell 7.4+ mandatory; avoid PSCust... | medium | NORMATIVAS-ARCHITECTURE.md | 2026-06-16 |
...
| LEARN-001 | Done" -ForegroundColor Green  # For hook output: ALWAYS use Write-SafeHook (redacts secrets) if (Get-Command Write-Sa... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | $repoRoot 'scripts\utilities\gv.ps1'  # CORRECT: always resolve repo root from script location $scriptDir = Split-Pat... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-001 | ax (REQUIRED)  ```powershell # CORRECT: $result / Should -Be $expected $value / Should -Not -BeNullOrEmpty $array / S... | medium | DEVELOPMENT-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | $path = "C:\hardcoded\path"                     # never hardcode absolute paths ```  ---  ## 7. Security Rules  / Rul... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | solo cubre el dashboard PowerShell (métricas). **Rule:** Todo subproyecto con `package.json` propio debe tener su pro... | medium | HAND-WRITTEN-NORMS.md | 2026-06-16 |
...
| LEARN-001 | nfig without sanitizing / Injection           / / Never store credentials in scripts — use `config/owner-auth.json` w... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | ----------------------- / ------------------- / / Never call `Invoke-Expression` on user input                       ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | ITCODE`** after calling external executables. - **Always `exit 1`** (not `throw`) when a script encounters a fatal co... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | crets immediately: `echo "::add-mask::$VALUE"`. - Never log secrets with `set -x` or PowerShell's `-Verbose` on secre... | medium | CI-HARDENING-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | ## 5.1 Annotations  Every AI-generated code block MUST be annotated:  ```powershell # AI-generated — reviewed by <rev... | medium | CODE-REVIEW-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | m(     [string]$Input,           # string params: always typed     [switch]$Verbose,         # flags: use [switch] no... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | arameter Declarations  ```powershell # REQUIRED — always use param() block with types param(     [string]$Input,     ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | eck.ps1`, `config/session-autostart.config.json`  ## NORM-009: Critical changes require explicit consent  **Context:*... | medium | HAND-WRITTEN-NORMS.md | 2026-06-16 |
...
| LEARN-001 | mpty `catch` blocks - No `Should Be` syntax (use `Should -Be` for Pester 5.x) - No circular dependencies between modu... | medium | DEVELOPMENT-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | fig-driven paths) - No empty `catch` blocks - No `Should Be` syntax (use `Should -Be` for Pester 5.x) - No circular d... | medium | DEVELOPMENT-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | / Code injection      / / Never call `[System.Reflection.Assembly]::Load` from user-supplied data    / DLL injection ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-001 | er completing **any significant work**, the agent MUST run:  ```powershell pwsh -File scripts/utilities/agent-verify.... | medium | AI-NORMATIVES.md | 2026-06-16 |
...
| LEARN-001 | m user-supplied data    / DLL injection       / / Always validate file paths before `Test-Path` / `Get-Content`      ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-001 | Handling  ```powershell # CORRECT: use Join-Path, never string concatenation $path = Join-Path $repoRoot 'scripts\uti... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-004 | mpty `catch` blocks - No `Should Be` syntax (use `Should -Be` for Pester 5.x) - No circular dependencies between modu... | medium | DEVELOPMENT-STANDARDS.md | 2026-06-16 |
| LEARN-005 | / Code injection      / / Never call `[System.Reflection.Assembly]::Load` from user-supplied data    / DLL injection ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-013 | t-Content`              / Path traversal      / / Never expand environment variables from external config without san... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-014 | eck.ps1`, `config/session-autostart.config.json`  ## NORM-009: Critical changes require explicit consent  **Context:*... | medium | HAND-WRITTEN-NORMS.md | 2026-06-16 |
| LEARN-015 | crets immediately: `echo "::add-mask::$VALUE"`. - Never log secrets with `set -x` or PowerShell's `-Verbose` on secre... | medium | CI-HARDENING-STANDARDS.md | 2026-06-16 |
...
| LEARN-018 | val.ps1`. 4. `scripts/utilities/agent-verify.ps1` must fail if multilingual routing matrix has mismatches. 5. No conf... | medium | AI-NORMATIVES.md | 2026-06-16 |
...
| LEARN-020 | ----------------------- / ------------------- / / Never call `Invoke-Expression` on user input                       ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-026 | Handling  ```powershell # CORRECT: use Join-Path, never string concatenation $path = Join-Path $repoRoot 'scripts\uti... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
...
| LEARN-028 | ITCODE`** after calling external executables. - **Always `exit 1`** (not `throw`) when a script encounters a fatal co... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
| LEARN-029 | ence = 'SilentlyContinue'`** at script scope. - **Always check `$LASTEXITCODE`** after calling external executables. ... | medium | POWERSHELL-STANDARDS.md | 2026-06-16 |
