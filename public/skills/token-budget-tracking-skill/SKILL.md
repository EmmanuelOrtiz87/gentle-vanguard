...
description: >
  Imported from mercury-agent-skills. Use when working with "token budget", "cost optimization", "token tracking", "LLM costs". Triggers: "token budget", "cost optimization", "token tracking", "LLM costs".
metadata:
