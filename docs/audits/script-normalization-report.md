...
- Syntax error: La referencia de variable no es vlida. El carcter ':' no va seguido de un carcter de nombre de variable vlido. Considere la posibilidad de usar ${} para delimitar el nombre.
