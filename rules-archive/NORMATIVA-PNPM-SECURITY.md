...
Eliminar riesgos de seguridad en la cadena de suministro de dependencias npm. Se adopta **pnpm**
como gestor exclusivo y **--ignore-scripts** como flag obligatorio para evitar ejecución de código
arbitrario en scripts post-instalación de paquetes.
...
Solo scripts de compilación explícitamente invocados vía `pnpm build:*` están permitidos. Ningún
script se ejecuta automáticamente en `postinstall` sin revisión de seguridad.
