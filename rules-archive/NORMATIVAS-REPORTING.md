...
5. **TRACEABLE**: Cada snapshot tiene timestamp y session ID. Los reportes referencian su fuente de
   datos y fecha de generación.
...
_\* `reports/dashboard.html` es generado, no fuente. Se puede ignorar o trackear según necesidad._
